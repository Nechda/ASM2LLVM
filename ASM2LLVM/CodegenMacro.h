...
[&](Value* op1)\
{\
    Value* res = m_builder.Create##irFunc(op1);\
...
[&](Value* op1, Value* op2)\
{\
    Value* res = m_builder.Create##irFunc(op1,op2);\
    ringBufValue.push_back(res);\
    return res;\
}
...
{\
    ...
    ringBufValue.push_back(m_builder.Create##irFunc(arg));\
}
...
{\
    ...
    ringBufValue.push_back(m_builder.Create##irFunc(arg1, arg2));\
}
